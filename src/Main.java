...
public class Main {
  ...
  // The time complexity is:
  // O(n) n = time complexity of computeProduct method
  ...
  // of the array
  // O(n^2) n = nums.length n = time complexity of computeFactorial method
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // O(n^2) n = wordsA.length n = wordsB.length
