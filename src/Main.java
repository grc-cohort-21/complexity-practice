...
public class Main {
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // O(n^2) n= wordsA.length and wordsB.length
  ...
  // O(n^2) n= size of wordSet and list
  ...
  // O(n) n= size of the set and list
